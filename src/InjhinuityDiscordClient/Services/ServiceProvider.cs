...
{
    public interface IBotServiceProvider : IServiceProvider, IEnumerable<object>
    {
        T GetService<T>();
    }

    /// <summary>
    /// Builds our service collection using discovery of a certain interface. Can then be converted
    /// and added to our API via dependency injection.
    /// </summary>
    public class ServiceProvider : IBotServiceProvider
    {
        public class ServiceProviderBuilder
        {
            ...
            /// <returns>Returns our builder instance.</returns>
        ...
        public ServiceProvider(IDictionary<Type, object> services)
        {
